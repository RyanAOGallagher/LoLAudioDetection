...
class BlitzDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        signal = self._mix_down_if_necessary(signal) #maybe not needed
...
if __name__ == "__main__":
    ...
    bd = BlitzDataset(ANNOTATIONS_FILE, AUDIO_DIR, mfcc, SAMPLE_RATE, NUM_SAMPLES)
    #print(f"There are {len(bd)} samples in the dataset.")
    #print(bd[244])
    signal, label = bd[0]
    #print(signal.shape)  //num_channels, num_mels, num_frames